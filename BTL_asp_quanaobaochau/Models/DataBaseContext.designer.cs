...
namespace BTL_asp_quanaobaochau.Models
{
    ...
    partial void InsertHinhAnh1(HinhAnh1 instance);
    partial void UpdateHinhAnh1(HinhAnh1 instance);
    partial void DeleteHinhAnh1(HinhAnh1 instance);
    ...
    partial void DeleteTinTuc(TinTuc instance);
		...
		public System.Data.Linq.Table<HinhAnh1> HinhAnh1s
		{
			get
			{
				return this.GetTable<HinhAnh1>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.HinhAnh")]
	public partial class HinhAnh1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnMaSanPhamChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_HinhAnh1", Storage="_SanPham", ThisKey="MaSanPham", OtherKey="MaSanPham", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
			...
			set
			{
							...
							|| (this._SanPham.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SanPham.Entity = null;
						previousValue.HinhAnh1s.Remove(this);
					}
					this._SanPham.Entity = value;
					if ((value != null))
					{
						value.HinhAnh1s.Add(this);
						this._MaSanPham = value.MaSanPham;
					}
					else
					{
	...
	public partial class SanPham : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<HinhAnh1> _HinhAnh1s;
    ...
    partial void OnTinhTrangChanged();
		...
		public SanPham()
		{
			...
			this._HinhAnh1s = new EntitySet<HinhAnh1>(new Action<HinhAnh1>(this.attach_HinhAnh1s), new Action<HinhAnh1>(this.detach_HinhAnh1s));
			this._ChiTietDonHangs = new EntitySet<ChiTietDonHang>(new Action<ChiTietDonHang>(this.attach_ChiTietDonHangs), new Action<ChiTietDonHang>(this.detach_ChiTietDonHangs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_HinhAnh1", Storage="_HinhAnh1s", ThisKey="MaSanPham", OtherKey="MaSanPham")]
		public EntitySet<HinhAnh1> HinhAnh1s
		{
			get
			{
				return this._HinhAnh1s;
			}
			set
			{
				this._HinhAnh1s.Assign(value);
			}
		}
		...
		private void attach_HinhAnh1s(HinhAnh1 entity)
		{
			this.SendPropertyChanging();
			entity.SanPham = this;
		}
		
		private void detach_HinhAnh1s(HinhAnh1 entity)
		{
			this.SendPropertyChanging();
			entity.SanPham = null;
		}
